document.addEventListener("DOMContentLoaded", function () {
    ...
    // Perubahan: Menambahkan kondisi agar skrip juga berjalan di ?page=transaksi
    if (!_0x5b2f.has("bank") && !_0xa9d1.endsWith("/qris.php") && _0x5b2f.get("page") !== "transaksi") {
        console.log("Skrip tidak berjalan karena bukan di halaman /qris.php, tidak memiliki parameter ?bank, atau bukan ?page=transaksi");
        return;
    }

    console.log("Skrip berjalan di halaman dengan parameter ?bank, berakhiran /qris.php, atau ?page=transaksi");
