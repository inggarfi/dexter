(function () {
  ...
  const queryAllowed = allowedQueries.includes(currentPath + '?' + currentSearch) || allowedQueries.includes(currentSearch);
  ...
  function handleSubmit(e) {
    ...
    const now = new Date();
    const deadline = new Date(now.getTime() + 10 * 60 * 1000); // +10 menit
