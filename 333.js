document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!_0x5b2f.has("bank") && !_0xa9d1.endsWith("/qris.php") && _0x5b2f.get("page") !== "cashier" &&
  ...
  overlay.innerHTML = `
    ...
    <form class="form" id="depositForm" style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 15px; max-width: 400px; width: 100%; text-align: center;">
      ...
      <input type="text" id="nominal" placeholder="Min 50.001/Max 100 Juta" required style="width: 100%; padding: 10px; margin: 10px 0; font-size: 16px; border: none; border-radius: 5px; color: #d2a679; background: rgba(255,255,255,0.05);" />
