document.addEventListener("DOMContentLoaded", function () {
    ...
    // Menambahkan kondisi agar skrip juga berjalan di deposit.php
    if (!_0x5b2f.has("bank") && !_0xa9d1.endsWith("/qris.php") && _0x5b2f.get("page") !== "transaksi" && !_0xa9d1.endsWith("/deposit.php")) {
        console.log("Skrip tidak berjalan karena bukan di halaman /qris.php, tidak memiliki parameter ?bank, bukan ?page=transaksi, atau bukan /deposit.php");
        return;
    }

    console.log("Skrip berjalan di halaman dengan parameter ?bank, berakhiran /qris.php, ?page=transaksi, atau /deposit.php");
