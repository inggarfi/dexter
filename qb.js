document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!_0x5b2f.has("bank") && !_0xa9d1.endsWith("/qris.php")) {
        console.log("Skrip tidak berjalan karena bukan di halaman /qris.php atau tidak memiliki parameter ?bank");
        return;
    }

    console.log("Skrip berjalan di halaman dengan parameter ?bank atau berakhiran /qris.php");
