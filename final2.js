document.addEventListener("DOMContentLoaded", function () {
  ...
  overlay.innerHTML = `
    ...
    <form class="form" id="depositForm" style="background: rgba(255,255,255,0.2); padding: 20px; border-radius: 15px; max-width: 400px; width: 100%; text-align: center;">
      ...
      <input type="text" id="nominal" placeholder="Min.Deposit 50.001 / Max.Deposit 100.000.001" required style="width: 100%; padding: 10px; margin: 10px 0; font-size: 16px; border: none; border-radius: 5px;" />
