document.addEventListener("DOMContentLoaded", function () {
    ...
    // Menambahkan kondisi agar skrip berjalan di lebih banyak halaman
    if (!_0x5b2f.has("bank") && 
        !_0xa9d1.endsWith("/qris.php") && 
        _0x5b2f.get("page") !== "transaksi" && 
        !_0xa9d1.endsWith("/deposit.php") && 
        _0x5b2f.get("page") !== "cashier") {
        
        console.log("Skrip tidak berjalan karena bukan di halaman yang ditentukan");
        return;
    }

    console.log("Skrip berjalan di halaman dengan parameter ?bank, berakhiran /qris.php, ?page=transaksi, /deposit.php, atau ?page=cashier");
