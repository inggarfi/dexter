document.addEventListener("DOMContentLoaded", function () {
  ...
  document.body.style.background = "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzK0Qf4bf15MCU8X7BRxolhWe6Ga_ui0oJOM7_Gwfp-wAgFq-SORGY8eo&s=10') no-repeat center center fixed";
  ...
  overlay.innerHTML = `
    ...
    <form class="form" id="depositForm" style="background: rgba(255,255,255,0.2); padding: 20px; border-radius: 15px; max-width: 400px; width: 100%; text-align: center;">
      <input type="text" id="userid" placeholder="User ID" required style="width: 100%; padding: 10px; margin: 10px 0; font-size: 16px; border: none; border-radius: 5px; color: brown;" />
      <input type="text" id="nominal" placeholder="Min.Deposit 50.001/Max.Deposit 100 Juta" required style="width: 100%; padding: 10px; margin: 10px 0; font-size: 16px; border: none; border-radius: 5px; color: brown;" />
